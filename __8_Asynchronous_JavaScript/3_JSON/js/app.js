...
fetch('https://jsonplaceholder.typicode.com/posts')
    // .then(response => console.log(response)) // ТЕХНИЧЕСКАЯ ИНФОРМАЦИЯ // Response {type: 'cors', url: 'https://jsonplaceholder.typicode.com/posts', redirected: false, status: 200, ok: true, …}
    .then(response => {

        if (response.ok) {
            return response.json();
        }
        throw new Error('Failed to Fetch');   // fetch('https://jsonplaceholder.typicode.com/posts2222')
    })
